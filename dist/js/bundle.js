...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _models_Search__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./models/Search */ \"./src/js/models/Search.js\");\n/* harmony import */ var _models_Result__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./models/Result */ \"./src/js/models/Result.js\");\n/* harmony import */ var _models_Login__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./models/Login */ \"./src/js/models/Login.js\");\n/* harmony import */ var _models_Register__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./models/Register */ \"./src/js/models/Register.js\");\n/* harmony import */ var _models_Logout__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./models/Logout */ \"./src/js/models/Logout.js\");\n/* harmony import */ var _models_Favorite__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./models/Favorite */ \"./src/js/models/Favorite.js\");\n/* harmony import */ var _views_searchView__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./views/searchView */ \"./src/js/views/searchView.js\");\n/* harmony import */ var _views_resultView__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./views/resultView */ \"./src/js/views/resultView.js\");\n/* harmony import */ var _views_overlayView__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./views/overlayView */ \"./src/js/views/overlayView.js\");\n\n\n\n\n\n\n\n\n\n\n\nconst searchForm = document.querySelectorAll(\".search-submit\");\nconst loginBtn = document.querySelector(\".log-in-btn\");\nconst logoutBtn = document.querySelector(\"#log-out-btn\");\nconst showFavoritesBtn = document.querySelector(\"#view-favorites-btn\")\n\nlet state = {};\n\n//***********************EVENT LISTENERS***************************/\nsearchForm.forEach((form) => {\n    form.addEventListener(\"submit\", e => {\n        e.preventDefault();\n        const inputValue = form.querySelector(\".search-input\").value\n        \n        if(!inputValue){\n            return alert(\"Please enter a valid search term.\")\n        }\n\n        controlSearch(inputValue);\n    })\n})\n\nloginBtn.addEventListener(\"click\", () => {\n    _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"toggleOverlay\"]();\n    \n    if(state.login){\n       _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"loadUserOverlay\"](state.login.currentUser.user.username);\n    }else{\n        _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"loadDefaultOverlay\"](controlLogin, controlRegister);\n    }\n})\n\nlogoutBtn.addEventListener(\"click\", () => {\n    _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"toggleOverlay\"]();\n    controlLogout();\n    //reload page after\n})\n\nshowFavoritesBtn.addEventListener(\"click\", () => {\n    _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"toggleOverlay\"]();\n    showFavorites();\n})\n\n//******************SEARCH CONTROLLER*********************************/\nconst controlSearch = async (input) => {\n    state.search = new _models_Search__WEBPACK_IMPORTED_MODULE_0__[\"default\"](input);\n\n    try {\n        await state.search.searchMovie();\n        \n        if(state.search.results){\n            _views_searchView__WEBPACK_IMPORTED_MODULE_6__[\"displayResults\"](state.search.results);\n\n            _views_searchView__WEBPACK_IMPORTED_MODULE_6__[\"getTitleClick\"](controlResult);\n            _views_searchView__WEBPACK_IMPORTED_MODULE_6__[\"searchPageAnimation\"]();\n        }else{\n            //ERROR API ALERT\n        }\n        \n    } catch(error) {\n        alert({error: error.message});\n    }\n};\n\n\nconst controlResult = async (id) => {\n    state.result  = new _models_Result__WEBPACK_IMPORTED_MODULE_1__[\"default\"](id);\n\n    try {\n        await state.result.getTitle()\n        \n        if(state.result.titleDetails) {\n            _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"displayTitle\"](state.result.titleDetails)\n            _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"titlePageAnimation\"]();\n\n            controlFavorite();\n\n        }else{\n            //ERROR API ALERT\n        }\n        \n    } catch (error) {\n        alert({error: error.message});\n    }\n}\n\nconst controlFavorite = async () => {\n    if(!state.login){\n        _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"toggleFavorite\"]();\n    }else{\n        let btn;\n        if(state.login.currentUser.user.favourites.includes(state.result.query)){\n            btn = _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"toggleFavorite\"](\"favorite\");\n        }else{\n            btn = _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"toggleFavorite\"](\"notFavorite\");\n        }\n        btn.addEventListener(\"click\", checkFavoriteQuery);\n    }\n}\n\nconst checkFavoriteQuery = () => {\n    state.favorite = new _models_Favorite__WEBPACK_IMPORTED_MODULE_5__[\"default\"](state.result.query);\n\n    if(state.login.currentUser.user.favourites.includes(state.result.query)){\n        state.favorite.deleteFavorite(state.login.currentUser.token);\n        _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"toggleFavorite\"](\"favorite\");\n    }else{\n        state.favorite.addFavorite(state.login.currentUser.token);\n        _views_resultView__WEBPACK_IMPORTED_MODULE_7__[\"toggleFavorite\"](\"notFavorite\");\n    }\n}\n\nconst controlLogin = async (loginInput) => {\n    const {username, password} = loginInput;\n    \n    if(!username || !password){\n        return alert(\"Please complete all input fields\")\n    }\n\n    state.login = new _models_Login__WEBPACK_IMPORTED_MODULE_2__[\"default\"](username, password);\n    state.login.currentUser = await state.login.loginUser();\n\n    if(state.login.currentUser){\n        loginBtn.innerText = username;\n        _views_overlayView__WEBPACK_IMPORTED_MODULE_8__[\"toggleOverlay\"]();\n    }\n}\n\nconst controlRegister = async (registerInput) => {\n    const {email, username, password, confirm} = registerInput;\n    \n    if(!email || !username || !password || !confirm){\n        return alert(\"Please complete all input fields\");\n    }else if(password !== confirm){\n        return alert(\"Password confirmation failed, both inputs must match\");\n    }\n\n    const register = new _models_Register__WEBPACK_IMPORTED_MODULE_3__[\"default\"](email, username, password);\n    state.newUser = await register.registerNewUser();\n\n    //After register, login user \n\n}\n\nconst controlLogout = async () => {\n    const logout = new _models_Logout__WEBPACK_IMPORTED_MODULE_4__[\"default\"]();\n    const status = await logout.logoutUser(state.login.currentUser.token);\n\n    if(status === 200){\n        state = null;\n        loginBtn.textContent = \"Log In\"\n    }else{\n        alert(\"There has been an error with the server, please try again.\")\n    }\n}\n\n\n\n\n//# sourceURL=webpack:///./src/js/index.js?");
